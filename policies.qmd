...
- Projects (including code, demo and presentation) 60%
...
### Grading Scale
The following grading scale will be applied to the **Final Weighted Total** at the end of the semester to calculate letter grades, grades are "rounded up" to the nearest integer: 
