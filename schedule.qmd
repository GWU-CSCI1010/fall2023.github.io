...
<table class="table table-hover w-auto">
  ...
  <tbody>
    ...
    <!-- <tr class="table-active">
      ...
      <td>
        <li>HW4 <a href = "https://github.com/GWU-CSCI1010/gwu-csci1010.github.io/raw/main/download/Week5.zip" download>![Download button](images/file-black.png){width=28}</a></li>
      </td>
    </tr> -->
    <!-- </tr>
