...
<table class="table table-hover w-auto">
  ...
  <tbody>
    ...
    <td>
      <ul>
        <li>Group Work Guidelines</li>
        <li>5-min Standup talk by: **Clare Jenney**</li>
      </ul>
    </td>
    <td>
      <li>Path Statement Sample<a href = "https://github.com/GWU-CSCI1010/gwu-csci1010.github.io/raw/main/download/Group_2_Path_Statement-Maya_Bardin.pdf" download>![Download button](images/file-black.png){width=28}</a></li>
