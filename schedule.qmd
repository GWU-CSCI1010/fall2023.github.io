...
The Final Project deliverables are due on **December 05, 2023**. Check-out the schedule to learn more about where to [submit all the deliverables](schedule.qmd#final-project).
:::
...
<table class="table table-hover w-auto">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Due Date [12/05/2023]</th>
      <td colspan="3">
        <div id="final-project"></div>
        <ul>
          Please submit your all your Final Project deliverables using this [**form**.](https://docs.google.com/forms/d/e/1FAIpQLSeb9VbcxspgukkjVIZEb4zpiz043LTuBkYa5RWQsesDscBLSA/viewform?usp=sharing)
        </ul>
    </td>
    </tr>
  </tbody>
