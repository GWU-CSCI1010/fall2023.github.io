...
<table class="table table-hover w-auto">
  ...
  <tbody>
    ...
    <tr>
      <th colspan="4">**HINT** for _HW2_: When you're working on <u>**HW2**</u>, make sure to include the argument `encoding='ISO-8859-1'` in your `pd.read_csv()` call. 
      It should look something like, `df = pd.read_csv("apsc1001_cs1010_400mgml_flow.csv", encoding='ISO-8859-1')`</th>
    </tr>
