...
<table class="table table-hover w-auto">
  ...
  <tbody>
    ...
    <tr class="table-active">
      ...
      <td>
        <ul>
          <li>Guest Lecture by **Lisa (Drusedum) Redman** and **Jonathan Yoo** - [_Office of Undergraduate Student Services and Advising (SEAS Advising)_](https://www.seas.gwu.edu/meet-your-academic-advisor)</li>
        </ul>
    </td>
    <td></td>
    <td></td>
