...
When you're working on <u>**HW2**</u>, make sure to include the argument `encoding='ISO-8859-1'` in your `pd.read_csv()` call or else you'll encounter an error. It should look something like, 
