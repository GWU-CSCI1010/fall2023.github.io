...
- **Step 2:** [Install Real VNC](realvnc-mac.qmd)

- **Step 3**: [Install VS Code for Mac](vscode-mac.qmd)

- **Step 4:** [Connect to the Raspberry Pi](realvnc-mac-connect.qmd)
...
- **Step 2:** [Install Real VNC](realvnc-windows.qmd)

- **Step 3**: [Install VS Code for Windows](vscode-windows.qmd)

- **Step 4:** [Connect to the Raspberry Pi](realvnc-windows-connect.qmd)
...
Also, once you've finished **installation Steps 1 and 2**, fill out the [Installation Check-In form](https://forms.gle/Y6Yi9HTZSjD1MPHb7) and the [CS1010 Entry form](https://forms.gle/EoKoGY5KHMi4wEBs7). Both the forms are **MANDATORY** to be filled out before the first class.
